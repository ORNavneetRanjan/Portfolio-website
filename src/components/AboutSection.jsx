        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href=""
                className="px-6 py-2 rounded-full border border-primaty text-primary hover:bg-primary/10 transition-colors duration-300"
              >
                DownLoad CV
              </a>
            </div>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Developing AI solutions in computer vision, NLP and
                    generative AI.
                  </p>
                </div>
              </div>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Strong DSA skills, team collaboration, and hackathon
